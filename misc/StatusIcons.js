...
const NetworkWiredIndicator = () => Widget.Stack({
  ...
  items: [
    ...
    ['unknown', FontIcon('󰖪')],
    ['disconnected', FontIcon('󰤯')],
    ['connected', FontIcon('󰖩')],
    ['connecting', FontIcon('󱛆')],
  ],
...
//     currentKeyboard = JSON.parse(Utils.exec('hyprctl -j devices')).keyboards.find(device => device.name === 'at-translated-set-2-keyboard')
//     if (currentKeyboard) {
