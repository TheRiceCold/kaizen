...
export const NotificationIndicator = (notifCenterName = 'sideright') => {
  const widget = Widget.Revealer({
    ...
    .hook(App, (self, currentName, visible) => {
      if (visible && currentName === notifCenterName) self.revealChild = false
    }),
    child: Widget.Box({
        children: [
...
export const BluetoothIndicator = () => Widget.Stack({
  ...
  items: [
    ['true', Widget.Label({ className: 'txt-norm icon-material', label: '󰂯' })],
    ['false', Widget.Label({ className: 'txt-norm icon-material', label: '󰂲' })],
  ],
...
const NetworkWifiIndicator = () => Widget.Stack({
  transition: 'slide_up_down',
  items: [
    ['disabled', Widget.Label({ className: 'txt-norm icon-material', label: '󰤭' })],
    ['disconnected', Widget.Label({ className: 'txt-norm icon-material', label: '󰤫' })],
    ['connecting', Widget.Label({ className: 'txt-norm icon-material', label: '󰈁' })],
    ['0', Widget.Label({ className: 'txt-norm icon-material', label: '󰤯' })],
    ['1', Widget.Label({ className: 'txt-norm icon-material', label: '󰤟' })],
    ['2', Widget.Label({ className: 'txt-norm icon-material', label: '󰤢' })],
